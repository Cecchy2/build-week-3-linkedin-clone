    ...
    <Navbar bg="light" expand="lg" className="navbar-custom">
      <div className="navbar-content">
        <Navbar.Brand href="#home" className="navbar-brand-custom">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="linkedin-icon" width="30" height="30">
        ...
        <div className="nav-items-grid">
          ...
          <Nav.Link href="#me" className="nav-item-custom">
            <img width="30" src="https://media.licdn.com/dms/image/C5603AQEsE-ujh9vJ1w/profile-displayphoto-shrink_100_100/0/1619603516362?e=1726704000&v=beta&t=BJ5CPVL_8Mr5SGuxa-PZ_mRF5EjekPnP5F2TqyfM45E" height="30" alt="Umberto Amoroso" className="profile-photo" />
